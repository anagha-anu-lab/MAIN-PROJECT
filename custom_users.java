...
public class custom_users extends BaseAdapter {
    String[]  donor_id,Photo,name,dob,gender,place,pin,post,district,phone,email,lid;
    private Context context;


    public custom_users(Context applicationContext, String[]  donor_id,String[] Photo,String[] name,String[] dob,String[] gender,String[] place,String[] pin,String[] post,String[] district,String[] phone,String[] email,String[] lid){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            ListView=inflator.inflate(R.layout.customuser,null);
