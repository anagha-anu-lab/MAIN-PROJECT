...
public class Viewbloodbank extends AppCompatActivity {
    ...
    String [] bb_id,bb_lid,name,email,phone,latitide,longitude,place,post,pin,district,license_no,status;
    ListView lvs;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://" + hu + ":5000/andviewbloodbank";
...
//                                    Toast.makeText(view_reply.this, "aaaaaaaaaa", Toast.LENGTH_SHORT).show();
                                ...
                                lvs.setAdapter(new custom_bloodbank(getApplicationContext(),bb_id,bb_lid,name,email,phone,latitide,longitude,place,post,pin,district,license_no,status));
